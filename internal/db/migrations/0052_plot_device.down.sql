DELETE FROM arcade_plays WHERE game = 'plot-device';
DELETE FROM arcade_scores WHERE game = 'plot-device';
DELETE FROM arcade_levels WHERE game = 'plot-device';
DELETE FROM arcade_player_stats WHERE game = 'plot-device';
