-- PLOT DEVICE (the turtle-graphics language lab) joins the arcade:
...
ALTER TABLE arcade_plays ADD CONSTRAINT arcade_plays_game_check CHECK (game IN
    ('chess','go','comet-buster','penny-pincher','brickfall','powder-keg','hexfection','interns','texas-holdem','red-tape','night-audit','lucky-penny','off-the-roof','pest-control','bumper-chairs','roll-call','floor-plan','homestead','lemonade','sub-basement','plot-device'));
