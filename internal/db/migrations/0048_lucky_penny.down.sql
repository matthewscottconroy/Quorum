DELETE FROM arcade_plays WHERE game = 'lucky-penny';
DELETE FROM arcade_scores WHERE game = 'lucky-penny';
DELETE FROM arcade_levels WHERE game = 'lucky-penny';
DELETE FROM arcade_player_stats WHERE game = 'lucky-penny';
