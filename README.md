...
| `GET` | `/arcade/ws` | member¹ | WebSocket room relay for online play (chess, go, powder-keg, hexfection, interns, texas-holdem — poker rooms add server-side dealing: `deal`/`street`/`reveal`) |
