...
func main() {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			r.With(mw.RequireRole("officer")).Get("/meetings/{id}/rsvp/names", meetingsH.RSVPNamesHandler)
			...
			r.With(mw.RequireRole("officer")).Get("/payment-reports/pending-count", payReportsH.PendingCountHandler)
